# -*- coding: utf-8 -*-
# @Time    : 2023/3/14 18:03
# @Author  : 蔍鸣霸霸
# @FileName: new_rank.py
# @Software: PyCharm
# @Blog    ：只因你太美
...
class XbRank():
    ...
    def getRank1(self):
        ...
        rank_name_group = '生活'
        date = '2022-01-17'
        path = 'b("/xdnphb/main/v1/day/rank?AppKey=joker&end={}&rank_name={}&rank_name_group={}&start={}&nonce=*****")'.format(
            date, rank_name, rank_name_group, date)
        nonce, xyz = self.getxyz(path)
        print(nonce, xyz)
    ...
    def getRank4(self):
        ...
        self.data = {"type": "美食", "rankDate": "2021-07-10", "start": 1, "size": 100, "rankType": "realTime",
                     "sort": "newrankIndex"}
        res = self.session.post(url=getRankUrl, headers=self.headers, json=self.data).text
        return res
