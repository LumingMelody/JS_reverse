...
function Stgnotion(_0x39f355, _0x2a7c02) {
    stringList = [_0x39f355];
    for (let _0x429bf1 = 0x0; _0x429bf1 < stringList['length']; _0x429bf1++) {
        if (stringList[_0x429bf1]['includes'](_0x39f355)) return window['_webmsxyw'](_0x39f355, _0x2a7c02);
    }
}
function get_xs(api, data, a1) {
    window.document.cookie = "a1=" + a1 + ';'
    return Stgnotion(api,data)
}
