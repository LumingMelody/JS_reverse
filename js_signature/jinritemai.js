...
;
var location = {
    href: "https://cc.oceanengine.com/inspiration/creative-radar/video",
    toString: function() {
        return location.href
    },
    host: "cc.oceanengine.com",
    hostname: "cc.oceanengine.com",
    origin: "https://cc.oceanengine.com",
    pathname: "/inspiration/creative-radar/video",
    port: "",
    protocol: "https:"
};
var document = {
...
function get_sign(url){
    ...
    return "https://fuwu.jinritemai.com"+i.url+"&_signature="+global.byted_acrawler.sign(i)
}

// url = "/api/svc/list?cate_id=47&order_by=sale_num&page_index=0&page_size=30";
// console.log(get_sign(url));
